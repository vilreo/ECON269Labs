---
title: "Lab 09 Matlab Conversion"
author: "Aaron Swoboda and Oliver Hall"
date: "2025-04-15"
output: pdf_document
---

This file aims to convert a series of Matlab scripts and data files into a R Markdown file that replicates the Tol (2023) Lab 9 for the economics of climate change. https://github.com/rtol/ClimateEconomics 
...
globalSCC <- sum(equityweight * SCC)
```